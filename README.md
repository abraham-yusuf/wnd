...
```bash
yarn create next-app -e https://github.com/abraham-yusuf/wnd
# or
npx create-next-app -e https://github.com/abraham-yusuf/wnd
```

Add an `.env.local` file to the root with the following:
```
WORDPRESS_GRAPHQL_ENDPOINT="http://wordpres.com/graphql"
```
...
* Categories 
* Authors 
* Search / Client side global navigation
* RSS 
* Sitemap 
